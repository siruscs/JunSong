...
class FinExpenseVerificationServiceImplTest
{
    ...
    @Test void generatedSupplementInheritsBorrowerFromSourceAdvance() { Harness h=new Harness(List.of(expense(1,10,"0",150,null)),List.of(advance(2,10,"0",100,null))); h.advances.get(0).setBorrower("张三"); h.verify("supp-borrower",List.of(1L),List.of(2L)); assertEquals("张三",h.generatedAdvance.getBorrower()); }
    @Test void generatedSurplusInheritsBorrowerFromSourceAdvance() { Harness h=new Harness(List.of(expense(1,10,"0",80,null)),List.of(advance(2,10,"0",100,null))); h.advances.get(0).setBorrower("张三"); h.verify("surplus-borrower",List.of(1L),List.of(2L)); assertEquals("张三",h.generatedAdvance.getBorrower()); }
