...
public interface SysMenuMapper
{
    ...
    /** 按路由地址精确查询菜单（低代码菜单生成用） */
    public List<SysMenu> selectMenusByPath(@Param("path") String path);

    /** 按父菜单ID查询子菜单（低代码菜单清理用） */
    public List<SysMenu> selectMenusByParentId(@Param("parentId") Long parentId);
}
