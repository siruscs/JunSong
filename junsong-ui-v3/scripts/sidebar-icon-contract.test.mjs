...
for (const icon of ['dashboard', 'monitor']) {
...
assert.doesNotMatch(read('src/assets/icons/svg/monitor.svg'), /chrome-extension|@font-face/)
...
assert.match(sidebarItem, /return fallbackIcon \|\| 'system'/)
