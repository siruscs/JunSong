...
<style scoped>
.section-card{margin-top:20rpx;padding:24rpx;background:#fff;border-radius:18rpx}.section-header{display:flex;align-items:center;gap:12rpx}.section-dot{width:12rpx;height:12rpx;border-radius:50%;background:#94a3b8}.section-dot.required{background:#087CF0}.section-title{font-size:29rpx;font-weight:700;color:#1e293b}.section-count{margin-left:auto;color:#94a3b8;font-size:23rpx}.add-detail-btn{display:flex;align-items:center;margin-left:12rpx;padding:10rpx 14rpx;border-radius:10rpx;background:#eaf4ff;color:#087CF0}.add-detail-icon{font-size:30rpx}.add-detail-text{margin-left:4rpx;font-size:23rpx}.detail-item{margin-top:18rpx;padding:18rpx;border:1rpx solid #e2e8f0;border-radius:14rpx}.detail-item-header,.detail-row,.detail-summary-row{display:flex;justify-content:space-between;align-items:center}.detail-item-header{margin-bottom:12rpx}.detail-item-title{font-size:26rpx;font-weight:600}.detail-delete{color:#dc2626;font-size:23rpx}.detail-row{padding:12rpx 0;color:#64748b;font-size:24rpx}.detail-picker{flex:1;margin-left:24rpx}.detail-control{display:flex;justify-content:space-between;padding:14rpx;border:1rpx solid #dbe4ef;border-radius:10rpx;color:#94a3b8}.detail-control.has-value{color:#1e293b}.detail-input{width:210rpx;padding:12rpx;border:1rpx solid #dbe4ef;border-radius:10rpx;text-align:right}.detail-value-text{color:#1e293b}.amount{color:#087CF0}.detail-empty{text-align:center;padding:50rpx;color:#94a3b8}.detail-summary{margin-top:18rpx;padding-top:16rpx;border-top:1rpx solid #e2e8f0}.detail-summary-row{padding:6rpx 0;color:#64748b}.detail-summary-value{color:#1e293b;font-weight:600}
</style>
