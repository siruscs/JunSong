  ...
  <div class="app-container report-page">
    ...
    <div class="chart-grid">
      <el-card class="chart-card">
        <template #header><span>成本类型统计</span></template>
        <div ref="categoryChart" class="chart-canvas"></div>
      </el-card>
      <el-card class="chart-card">
        <template #header><span>门店成本对比</span></template>
        <div ref="deptChart" class="chart-canvas"></div>
      </el-card>
      <el-card class="chart-card wide">
        <template #header><span>成本趋势</span></template>
...
export default {
  ...
  methods: {
    ...
    initTrendChart() {
      ...
      this.trendChart.setOption(this.getTrendLineOptions(data, "totalAmount", "成本"));
    }
  }
};
</script>
