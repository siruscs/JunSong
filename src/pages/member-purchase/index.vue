        ...
        <view class="card-body compact-body">
          ...
          <view class="compact-row3">
            ...
            <text class="compact-status-group">
              <text v-if="returnTagText(row)" class="compact-status" :class="returnTagClass(row)">{{ returnTagText(row) }}</text>
