...
public interface MemMemberCardTypeMapper
{
     ...
     * 查询等级配置详情
     */
    public MemMemberCardType selectCardTypeByTypeCode(String typeCode);

    /**
     * 查询所有启用的等级配置（按 min_growth 升序）
     */
    public List<MemMemberCardType> selectEnabledCardTypes();
     ...
     * 校验等级编码是否唯一
     */
    public MemMemberCardType checkTypeCodeUnique(String typeCode);
}
