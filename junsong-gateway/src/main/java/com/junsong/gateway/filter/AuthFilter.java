...
import com.junsong.common.core.constant.TokenConstants;
...
import com.junsong.gateway.config.properties.IgnoreWhiteProperties;
...
public class AuthFilter implements GlobalFilter, Ordered
{
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain)
    {
        ...
        if (!islogin)
        {
            ...
            String kickoutKey = CacheConstants.SYS_CONFIG_KEY + "kickout:" + userid;
            if (StringUtils.isNotEmpty(userid) && redisService.hasKey(kickoutKey))
            {
